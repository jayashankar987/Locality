...
public class ShowHidePasswordEditText extends AppCompatEditText {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            typeface = attrsArray.getInt(R.styleable.PoppinsFont_textFontStyle, R.integer.poppins_font_regular);
            attrsArray.recycle();
        } else {
        ...
        setTypeface(Typeface.createFromAsset(getContext().getAssets(), FontStyle.Companion.getFont(typeface)));
    }
